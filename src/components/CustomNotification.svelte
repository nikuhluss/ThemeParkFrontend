<!-- see: https://github.com/keenethics/svelte-notifications/blob/master/src/components/DefaultNotification.svelte -->
...
<script>
  ...
  const getClass = (suffix) => {
    ...
    return `custom-svelte-notification${defaultSuffix}${withoutStyles ? '' : defaultNotificationClass}${defaultNotificationType}`;
  };
</script>
